...
- 対戦アプリ内ではオーダー作成機能や各個人の打席結果も記載を行うことで個人の打率
  や打点をはじめ、チーム打率なども自動で保管することができます。
  対戦中には、相手チームの打撃結果も見ることができるので、より戦術的な野球をすることが可能になります。
...
'![demo]()'
https://raw.github.com/wiki/zerechi-m/base_b/gif/top_page.gif
